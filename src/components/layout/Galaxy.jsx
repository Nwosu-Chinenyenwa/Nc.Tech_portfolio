...
vec3 StarLayer(vec2 uv) {
  ...
  for (int y = -1; y <= 1; y++) {
    for (int x = -1; x <= 1; x++) {
      ...
      // ✅ Use your custom color: #36ad5a40
      vec3 base = vec3(0.211, 0.678, 0.353); // equivalent to #36ad5a
...
void main() {
  ...
  // ✅ Apply your color tint globally (#36ad5a40)
  col *= vec3(0.211, 0.678, 0.353);

  if (uTransparent) {
    float alpha = length(col);
    alpha = smoothstep(0.0, 0.3, alpha);
    alpha = min(alpha, 0.25); // last two digits (40) as opacity ~25%
